          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white text-base font-bold rounded-xl transition-all shadow-md hover:shadow-lg"
              >
