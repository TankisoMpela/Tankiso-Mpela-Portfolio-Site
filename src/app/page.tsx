...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans pb-32">
        ...
        <div className="max-w-[100rem] mx-auto flex flex-col md:flex-row items-start md:items-center gap-10">
          ...
          <div className="flex-1 w-full max-w-4xl">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-sm font-bold rounded-xl transition-all shadow-md hover:shadow-lg"
            >
              💼 View Freelance Services & Rates
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </button>
      ...
      {showRates && (
        <RatesModal onClose={() => setShowRates(false)} />
      )}
    </div>
  );
}
